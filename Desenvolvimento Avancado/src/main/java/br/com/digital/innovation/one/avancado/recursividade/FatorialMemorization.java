package br.com.digital.innovation.one.avancado.recursividade;
...
public class FatorialMemorization {
	...
	private static Map<Integer,Integer> MAPA_FATORIAL = new HashMap<>();
	...
	private static Integer fatorialComMemorization(Integer value) {
		if(value == 1) {
			return value;
		} else {
